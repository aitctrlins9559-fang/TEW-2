  ...
  return (
    <div className="space-y-5 sm:space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-5 sm:gap-6">
        ...
        <div className="md:col-span-7 bg-white/80 backdrop-blur-xl p-6 sm:p-8 rounded-[2.25rem] border border-slate-100/90 shadow-[0_12px_36px_-6px_rgba(15,23,42,0.05)] relative overflow-hidden flex flex-col justify-between space-y-6 transition-all duration-300 hover:shadow-[0_18px_45px_-6px_rgba(15,23,42,0.08)] group">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 relative z-10">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-2xl bg-indigo-50/90 text-indigo-600 flex items-center justify-center border border-indigo-100/80 font-bold shadow-2xs shrink-0 group-hover:scale-105 transition-transform duration-300">
          ...
          <div className="relative z-10 space-y-3">
            <div className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 font-mono tracking-tight break-all leading-none">
            ...
            <div className="space-y-2.5 pt-1">
              <div className="flex flex-wrap items-center gap-2.5">
                ...
                <button
                  ...
                  className={`px-3.5 py-2 rounded-2xl border font-mono font-bold text-xs inline-flex flex-wrap items-center gap-2 transition-all duration-200 active:scale-95 shadow-2xs btn-interact max-w-full ${
                ...
                >
                  {currentRange.isPositive ? <TrendingUp className="w-4 h-4 shrink-0 stroke-[2.5]" /> : <TrendingDown className="w-4 h-4 shrink-0 stroke-[2.5]" />}
                  <span>
                ...
                {activeRange !== 'ALL' && (
                  <div
                    className={`px-3.5 py-2 rounded-2xl border font-mono font-bold text-xs inline-flex items-center gap-1.5 max-w-full shadow-2xs ${
                      totalProfit === null
              ...
              <div className="text-[11px] text-slate-500 font-mono flex items-start sm:items-center gap-2 bg-slate-50/80 backdrop-blur-sm px-3.5 py-2 rounded-2xl border border-slate-100/90 leading-relaxed shadow-2xs">
          ...
          <div className="grid grid-cols-3 gap-3 p-3.5 bg-slate-50/60 backdrop-blur-md rounded-2xl border border-slate-100 text-xs font-mono relative z-10">
            <div className="space-y-0.5">
              <span className="text-[10px] text-slate-400 font-bold block uppercase tracking-wider">建倉總成本</span>
              <span className="font-bold text-slate-800 text-xs sm:text-sm">{formatMoney(totalCost, isPrivacy)}</span>
            </div>
            <div className="space-y-0.5 border-x border-slate-200/50 px-2 sm:px-3">
              <span className="text-[10px] text-slate-400 font-bold block uppercase tracking-wider">總持股檔數</span>
              <span className="font-bold text-slate-800 text-xs sm:text-sm">{totalCount} 檔</span>
            </div>
            <div className="space-y-0.5 pl-1 sm:pl-2">
              <span className="text-[10px] text-slate-400 font-bold block uppercase tracking-wider">台美配置</span>
              <span className="font-bold text-indigo-600 text-xs sm:text-sm">{twCount}台 ｜ {usCount}美</span>
            </div>
          </div>
        </div>

        {/* BENTO HERO BOX 2: Passive Income Gauge & Dividend Target Ring (Cols 5/12) */}
        <div className="md:col-span-5 bg-white/80 backdrop-blur-xl p-6 sm:p-8 rounded-[2.25rem] border border-slate-100/90 shadow-[0_12px_36px_-6px_rgba(15,23,42,0.05)] relative overflow-hidden flex flex-col justify-between space-y-5 transition-all duration-300 hover:shadow-[0_18px_45px_-6px_rgba(15,23,42,0.08)] group">
          ...
          <div className="flex items-center justify-between relative z-10">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-2xl bg-emerald-50/90 text-emerald-600 border border-emerald-100/80 flex items-center justify-center font-bold shadow-2xs shrink-0 group-hover:scale-105 transition-transform duration-300">
                <Target className="w-5 h-5 stroke-[2.25]" />
              </div>
              <div>
                <h3 className="text-[11px] font-black text-slate-400 uppercase tracking-widest font-mono">被動收入現金流</h3>
                <p className="text-xs font-bold text-slate-900 mt-0.5">Passive Income Target</p>
              </div>
            </div>
            <span className="text-xs font-mono font-black text-emerald-700 bg-emerald-50/90 border border-emerald-200/80 px-3 py-1.5 rounded-2xl shadow-2xs">
          ...
          <div className="space-y-4 relative z-10">
            ...
            <div className="space-y-2">
              <div className="w-full bg-slate-100/80 rounded-full h-3.5 p-0.5 border border-slate-200/50 overflow-hidden shadow-inner">
                <div
          ...
          <div className="bg-slate-50/70 backdrop-blur-md p-4 rounded-2xl border border-slate-100 flex items-center justify-between text-xs font-mono relative z-10 shadow-2xs">
            <div className="flex items-center gap-2.5">
              <div className="w-7 h-7 rounded-xl bg-emerald-100/80 text-emerald-700 flex items-center justify-center font-bold">
                <Calendar className="w-4 h-4 stroke-[2.25]" />
              </div>
              <span className="text-slate-700 font-bold">預估年受領股息總額</span>
            </div>
